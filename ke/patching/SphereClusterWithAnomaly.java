 ...
 *
 */
public class SphereClusterWithAnomaly extends Cluster {
	...
	public SphereClusterWithAnomaly(double[] center, double radius) {
         ...
         */
	public SphereClusterWithAnomaly() {
	}

        /**
         * create new Sphere by giving the center and radius
         * @param center
         * @param radius
         * @param weightedSize 
         */
	public SphereClusterWithAnomaly( double[] center, double radius, double weightedSize) {
		this();
		this.center = center;
		this.radius = radius;
        ...
        /**
         * Creates a Sphere with a random coordinate, keeping the sphere inside the boundaries
         * @param dimensions
         * @param radius
         * @param random 
         */
	public SphereClusterWithAnomaly(int dimensions, double radius, Random random) {
		this();
        ...
        /** 
         * Builds an enclosing minimal sphere around the given instances
         * @param instances
         * @param dimension 
         */
	public SphereClusterWithAnomaly(List<?extends Instance> instances, int dimension){
		this();
	...
	public double overlapRadiusDegree(SphereClusterWithAnomaly other) {
	...
	public void combine(SphereClusterWithAnomaly cluster) {
	...
	public void merge(SphereClusterWithAnomaly cluster) {
		double[] c0 = getCenter();
		double w0 = getWeight();
		double r0 = getRadius();
	...
	public double getCenterDistance(SphereClusterWithAnomaly other) {
	 ...
	 */
	public double getHullDistance(SphereClusterWithAnomaly other) {// TODO hier anpassen
		double distance = 0.0;
		//get the center through getCenter so subclass have a chance
		double[] center0 = getCenter();
		double[] center1 = other.getCenter();
	 ...
	 */
	public boolean overlapSave(SphereClusterWithAnomaly other){
	...
	public double[] getDistanceVector(SphereClusterWithAnomaly other){
	 ...
	 */
	public Instance sample(Random random) {                                                 // TODO hier anpassen
