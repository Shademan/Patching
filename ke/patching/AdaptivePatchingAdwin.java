 ...
 * @author SKauschke
 */
public class AdaptivePatchingAdwin extends AbstractClassifier {
    ...
    protected int counter_zero = 0;
    protected int counter_one = 0;
    protected ArrayList<Double> accuracy_array = new ArrayList<>();

    protected double average = 0;
    protected double variance = 0;
    protected double old_variance = 0;
    protected double real_variance_epsilon = 0;
    ...
    public FloatOption variance_epsilon = new FloatOption("VarianceEpsilon", 'y', "condition to stop increasing the number of learning batches. The value will be multiplied with 10^-6", 1, 0, 10000);
    ...
    public FlagOption adwinOnly = new FlagOption("AdwinOnly", 'z', "If this is set, the batchesToKeep grow to 'infinity'. The both settings above are ignored.");
    ...
    public void resetLearningImpl() {
        ...
        System.out.println(adwinDelta.getValue());
        System.out.println(variance_epsilon.getValue());
        this.maxBatchesToKeep = batchesToKeep.getValue();
        this.real_variance_epsilon = (double)(variance_epsilon.getValue() / 1000000);
        ...
        if((this.ADError.getWidth() / batchSize.getValue()) < 1){
            ...
            if(adwinOnly.isSet()){
                ...
                if (Math.abs((double) variance - old_variance) < (double) real_variance_epsilon) {
                    ...
                    System.out.println("Batchsize wird nicht erhöht wegen Varianz");
                }
