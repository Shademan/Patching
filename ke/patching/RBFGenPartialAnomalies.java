...
public class RBFGenPartialAnomalies extends ClusteringStream implements InstanceStream {
    ...
    private class GeneratorCluster implements Serializable{
        ...
        SphereClusterWithAnomaly generator;
        int kill = -1;
        ...
        ArrayList<SphereClusterWithAnomaly> microClusters = new ArrayList<SphereClusterWithAnomaly>();
        ...
        public GeneratorCluster(int label) {
            ...
            while(outofbounds && tryCounter < maxOverlapFitRuns){
                ...
                generator = new SphereClusterWithAnomaly(center, radius);
            }
        ...
        public GeneratorCluster(int label, SphereClusterWithAnomaly cluster) {
...
//                    System.out.println("Cleaning up macro cluster "+generator.getId());
        ...
        private void addInstance(Instance instance){
            ...
            for (int m = microClusters.size()-1; m >=0 ; m--) {
                SphereClusterWithAnomaly micro = microClusters.get(m);
            ...
            if(!inserted){
                ...
                if(minMicroIndex!=-1){
                    ...
                    SphereClusterWithAnomaly s = new SphereClusterWithAnomaly(microClustersPoints.get(minMicroIndex),numAttsOption.getValue());
                ...
                if(minMicroIndex == -1){
                    ...
                    SphereClusterWithAnomaly s;
                    if(alt == 0)
                        s = new SphereClusterWithAnomaly(microPoints,numAttsOption.getValue());
                    else
                        s = new SphereClusterWithAnomaly(generator.getCenter(),generator.getRadius(),1);
...
//            }
        ...
        private String tryMerging(GeneratorCluster merge){
           ...
           if(overlapDegree > merge_threshold){
                SphereClusterWithAnomaly mcluster = merge.generator;
...
//                generator.setWeight(weight + mweight);
        ...
        private String splitKernel(){
            ...
            SphereClusterWithAnomaly spcluster = null;

            double[] center = generator.getCenter();
            spcluster = new SphereClusterWithAnomaly(center, radius, weight);
